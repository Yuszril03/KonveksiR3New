...
class M_ActivityEmploye extends Model
{
    protected $table = 'activity_employe';
    ...
    public function getOneActivity($data)
    {
        $hasil = $this->where($data);
        return $hasil->orderBy('Id', 'DESC')->get();
    }
    ...
    public function getDataLog($data, $sort)
    {
        if ($data == false) {
            // $hasil = $this->join('jenisproduk', 'produk.jenisProduk = jenisproduk.idJenisProduk')
            //     ->join('bahan', 'produk.jenisBahan = bahan.idBahan');
        ...
        $hasil = $this->where($data)->orderBy('Id', $sort);
        return $hasil->get();
    }

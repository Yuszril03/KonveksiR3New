...
<body>
                            ...
                            <div class="card">
                                <div class="card-body px-4 py-4-5">
                                    <div class="row">
                                        <div class="col-lg col-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="urutan" id="urutan" class="form-select radius-form-search">
                                                    <option value="asc" selected>Terlama-Terbaru</option>
                                        ...
                                        <div class="col-lg col-6">
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label">Produk <span class="text-danger"><sup>(*)</sup></span></label>
                                                <select name="produk" id="produk" class="form-select radius-form-search">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg col-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="status" id="status" class="form-select radius-form-search">
                                                    ...
                                                    <option value="4">Stok   Keluar</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg col-12">
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label ">Tanggal Laporan <span class="text-danger"><sup>(*)</sup></span></label>
                                ...
                                <div class="card-body px-4 py-4-5">
                                    ...
                                    <div id="loadingData" class="d-none">
                                        <center class="p-4">
                                            ...
                                            <h6 class="mt-3">Mengambil Data Produk</h6>
                                        </center>
                                    </div>
                                    <div class="text-center d-none mt-3 mb-3" id="emptydata">
                                        <img src="<?= base_url() ?>/Asset/Icon/empty-product.svg" class="custom-img" alt="">
    ...
    <?= view('Template/V_JS') ?>
    <script src="<?= base_url() ?>/Asset/Main/Custom/page/product/report_owner.js"></script>

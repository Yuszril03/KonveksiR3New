...
<body>
                                    ...
                                    <div id="contenProduct">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-12">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input onkeyup="isNumberKey(this,event)" type="text" class="form-control w-50" placeholder="Ketik Disini..." name="Stok" id="Stok">
                                                    <select disabled class="form-control" id="typeStok" aria-label="Example select with button addon">
    ...
    <?= view('Template/V_JS') ?>
    <script src="<?= base_url() ?>/Asset/Main/Custom/page/product/from.js"></script>
    <!-- <script>

...
<body>
        ...
        <div id="main" class="layout-horizontal">
            ...
            <div class="content-wrapper container">
                ...
                <div class="page-heading">
                    <h3><button class="btn" id="Back1"><i class="bi bi-arrow-left-circle" style="font-size: 1.5rem; margin-top:-10px"></i></button> Edit Transaksi</h3>
                </div>
                                                ...
                                                <div class="modal-content p-4" style="border-radius: 20px;">
                                                    <div class="modal-body">
                                                        <center>
                                                            ...
                                                            <button id="prevRiwayat" class="btn btn-primary">Kembali ke Riwayat Transaksi</button>
                                                        </center>
                                                    </div>
                                            ...
                                            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-lg-3">
                                                                <img id="detailImage" src="<?= base_url() ?>/Asset/Icon/no-image.jpg" class="img-thumbnail" style="width: 250px; border-radius: 20px;" alt="">
                                                            </div>
                                                            <div class="col-lg">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg col">
                                            <p class="fw-bold text-end" id="idTrans">123444</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top: -8px;">
                                        ...
                                        <div class="col-lg col">
                                            <p class="fw-bold text-end" style="font-size: 11pt;" id="subtotal">123444</p>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: -8px;">
                                        <div class="col-lg-4 col-5">
                                        ...
                                        <div class="col-lg col">
                                            <p class="fw-bold text-end" style="font-size: 11pt;" id="hutang">123444</p>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: -8px;">
                                        <div class="col-lg-4 col-5">
                                        ...
                                        <div class="col-lg col">
                                            <p class="fw-bold text-end" style="font-size: 14pt;" id="total">123444</p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="alertTransOpen" style="background: rgba(0,0,0,.8);" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                <div class="modal-content p-4" style="border-radius: 30px;">
                                                    <div class="modal-body text-center ">
                                                        ...
                                                        <p>Transaksi ini sedang dibuka user lain</p>
                                                        <button type="button" id="btnCloseTrans" class="btn btn-primary">Oke</button>
                                                    </div>
    ...
    <script src="<?= base_url() ?>/Asset/Main/Custom/page/transaksi/editTrans.js"></script>

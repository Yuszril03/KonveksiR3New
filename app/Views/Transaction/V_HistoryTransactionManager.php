...
<body>
                            ...
                            <div class="card">
                                <div class="card-body px-4 py-4-5">
                                    ...
                                    <div style="margin-left: 10px;">
                                        ...
                                        <span id="textkasir" class="badge d-none" style="background: #2496ed;">Secondary</span>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <button type="button" id="closeModalFilter" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
    ...
    <?= view('Template/V_JS') ?>
    <script src="<?= base_url() ?>/Asset/Main/Custom/page/transaksi/historytrans_manager.js"></script>
    <!-- <script>

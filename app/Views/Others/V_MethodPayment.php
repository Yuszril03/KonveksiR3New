...
<body>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1" class="form-label">Jenis Bank</label>
                                                        <select class="form-select" id="bankFilter" aria-label="Default select example">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <label for="exampleFormControlInput1" class="form-label">Nama Pengguna Rekening <sup><span class="text-danger">*</span></sup></label>
                                                    ...
                                                    <div class="mb-3">
                                                        <input type="hidden" id="tempBank">
                                                        <label for="exampleFormControlInput1" class="form-label">Jenis Bank <sup><span class="text-danger">*</span></sup></label>
                                                        <select name="bank" id="bank" class="form-select"></select>
                                                        <div id="bankHelp" class="invalid-feedback"></div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <input type="hidden" id="tempRek">
                                                        <label for="exampleFormControlInput1" class="form-label">Nomor Rekening <sup><span class="text-danger">*</span></sup></label>
                                                        <input type="text" class="form-control" onkeyup="isNumberKey(this,event)" id="Rek" aria-describedby="RekHelp" placeholder="Ketik Disini...">
                                                        <div id="RekHelp" class="invalid-feedback"></div>
                                                    </div>
    ...
    <?= view('Template/V_JS') ?>
    <script src="<?= base_url() ?>/Asset/Main/Custom/page/other/paymentmethod/index.js"></script>
    <!-- <script>

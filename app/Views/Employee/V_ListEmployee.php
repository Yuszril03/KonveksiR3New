...
<body>
                                        ...
                                        <table id="table" class="table " style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-orderable="false">Root</th>
                                                    <th>Terakhir Edit</th>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 col-12">
                                                            <div class="mb-3">
                                                                <label for="exampleFormControlInput1" class="form-label">Akun Root</label>
                                                                <select class="form-select" id="account" aria-label="Default select example">
                                                                    <option selected value="2">Semua Akun</option>
    ...
    <?= view('Template/V_JS') ?>
    <script src="<?= base_url() ?>/Asset/Main/Custom/page/employee/listemployee.js"></script>
    <!-- <script>
